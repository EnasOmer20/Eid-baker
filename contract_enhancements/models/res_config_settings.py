...
class HrSettings(models.TransientModel):
    ...
    notify_days_contract = fields.Integer(string="Notify Days Before Contract Expiry", default=30)
    ...
    def set_values(self):
        ...
        config.set_param('hr_contract.notify_days_contract', self.notify_days_contract)
    ...
    def get_values(self):
        ...
        res.update(
            ...
            notify_days_contract=int(config.get_param('hr_contract.notify_days_contract', default=30)),
        )
        return res
